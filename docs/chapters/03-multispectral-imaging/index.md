---
title: "Chapter 3: Multispectral Imaging Fundamentals"
description: "How multispectral sensors capture light beyond human vision to reveal turf health indicators invisible to the naked eye, from NDVI to red edge reflectance."
---
...
!!! info "Learning Objectives"
    ...
    - **Explain the electromagnetic spectrum** and how plants interact with different wavelengths of light
    - **Calculate and interpret key vegetation indices** including NDVI, NDRE, and GNDVI
    - **Describe the significance of the red edge** (~730nm) in detecting early plant stress
    - **Differentiate between RGB, NIR, and multispectral imaging** and their respective use cases in turf analysis

## Key Concepts

1. Electromagnetic spectrum and visible light
2. Near-infrared (NIR) reflectance in healthy vegetation
...
6. Red edge inflection point (~730nm)
7. Spectral bands and bandpass filters
8. Chlorophyll absorption and reflectance patterns
9. RGB imagery vs. multispectral data
10. Reflectance calibration panels
11. Radiometric correction
12. Spectral signatures of turf stress
13. Index saturation in dense canopies
14. False color composites
15. Band math and custom index creation
