---
title: "Chapter 13: Building a Drone Services Business"
description: "From FAA Part 107 certification to pricing models, client acquisition, and scaling a turf analytics drone service — including the Positive Altitude case study."
---
...
!!! info "Learning Objectives"
    ...
    - **Navigate FAA Part 107 certification** and ongoing compliance requirements for commercial drone operations
    - **Develop pricing models** for turf analytics services ranging from $500-2,000 per flight
    - **Design a Drone-as-a-Service (DaaS) offering** with recurring revenue structures
    - **Build a client acquisition pipeline** targeting golf course superintendents and management companies

## Key Concepts

1. FAA Part 107 Remote Pilot Certificate
2. Airspace authorization (LAANC, Part 107 waivers)
3. Pricing models ($500-2,000 per flight)
4. Drone-as-a-Service (DaaS) subscription structures
5. Insurance requirements (hull and liability)
6. Client acquisition strategies for golf courses
7. Portfolio and demo flight development
8. Superintendent relationship building
9. Proposal and contract templates
10. Equipment investment and depreciation
11. Scaling operations with subcontractors
12. Seasonal revenue management
13. Positive Altitude Growth case study
14. Business entity structure and liability
15. Revenue milestones and growth trajectory
